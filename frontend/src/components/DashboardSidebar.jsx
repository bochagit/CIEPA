    ...
    (viewport) => (
      <React.Fragment>
        ...
        >
          ...
          >
            <DashboardSidebarHeaderItem>Gestión de Noticias</DashboardSidebarHeaderItem>
            <DashboardSidebarPageItem
              id="news-list"
              title="Lista de Noticias"
              icon={<ListIcon />}
              href="/dashboard/news"
              selected={!!matchPath('/dashboard/news', pathname) || !!matchPath('/dashboard/news/:newsId', pathname) || pathname === '/dashboard/' || pathname === '/dashboard'}
            />
            <DashboardSidebarPageItem
              id="news-create"
              title="Nueva Noticia"
              ...
              selected={!!matchPath('/dashboard/news/new', pathname)}
            />
            <DashboardSidebarDividerItem />
            <DashboardSidebarHeaderItem>Categorías</DashboardSidebarHeaderItem>
            <DashboardSidebarPageItem
              id="news-categories"
